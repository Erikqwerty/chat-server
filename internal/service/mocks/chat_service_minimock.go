...
//go:generate minimock -i github.com/erikqwerty/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
type ChatServiceMock struct {
	...
	funcCreateChat          func(ctx context.Context, cp1 *model.CreateChat) (i1 int64, err error)
	...
	funcDeleteChat          func(ctx context.Context, i1 int64) (err error)
	funcDeleteChatOrigin    string
	inspectFuncDeleteChat   func(ctx context.Context, i1 int64)
	afterDeleteChatCounter  uint64
	beforeDeleteChatCounter uint64
	DeleteChatMock          mChatServiceMockDeleteChat

	funcJoinChat          func(ctx context.Context, cp1 *model.ChatMember) (jp1 *model.JoinChat, err error)
	funcJoinChatOrigin    string
	inspectFuncJoinChat   func(ctx context.Context, cp1 *model.ChatMember)
	afterJoinChatCounter  uint64
	beforeJoinChatCounter uint64
	JoinChatMock          mChatServiceMockJoinChat

	funcSendMessage          func(ctx context.Context, mp1 *model.Message) (err error)
	funcSendMessageOrigin    string
	inspectFuncSendMessage   func(ctx context.Context, mp1 *model.Message)
...
func NewChatServiceMock(t minimock.Tester) *ChatServiceMock {
	...
	m.JoinChatMock = mChatServiceMockJoinChat{mock: m}
	m.JoinChatMock.callArgs = []*ChatServiceMockJoinChatParams{}
...
func (mmCreateChat *mChatServiceMockCreateChat) Set(f func(ctx context.Context, cp1 *model.CreateChat) (i1 int64, err error)) *ChatServiceMock {
	if mmCreateChat.defaultExpectation != nil {
...
func (mmCreateChat *ChatServiceMock) CreateChat(ctx context.Context, cp1 *model.CreateChat) (i1 int64, err error) {
	...
	if mmCreateChat.CreateChatMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.cp1 != nil && !minimock.Equal(*mm_want_ptrs.cp1, mm_got.cp1) {
				mmCreateChat.t.Errorf("ChatServiceMock.CreateChat got unexpected parameter cp1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Expect(ctx context.Context, i1 int64) *mChatServiceMockDeleteChat {
...
func (mmDeleteChat *mChatServiceMockDeleteChat) ExpectI1Param2(i1 int64) *mChatServiceMockDeleteChat {
	if mmDeleteChat.mock.funcDeleteChat != nil {
		mmDeleteChat.mock.t.Fatalf("ChatServiceMock.DeleteChat mock is already set by Set")
	}
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Inspect(f func(ctx context.Context, i1 int64)) *mChatServiceMockDeleteChat {
...
func (mmDeleteChat *mChatServiceMockDeleteChat) Set(f func(ctx context.Context, i1 int64) (err error)) *ChatServiceMock {
	if mmDeleteChat.defaultExpectation != nil {
...
// Then helper
func (mmDeleteChat *mChatServiceMockDeleteChat) When(ctx context.Context, i1 int64) *ChatServiceMockDeleteChatExpectation {
	if mmDeleteChat.mock.funcDeleteChat != nil {
		mmDeleteChat.mock.t.Fatalf("ChatServiceMock.DeleteChat mock is already set by Set")
	}
...
func (mmDeleteChat *ChatServiceMock) DeleteChat(ctx context.Context, i1 int64) (err error) {
	...
	if mmDeleteChat.DeleteChatMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.i1 != nil && !minimock.Equal(*mm_want_ptrs.i1, mm_got.i1) {
				mmDeleteChat.t.Errorf("ChatServiceMock.DeleteChat got unexpected parameter i1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
type mChatServiceMockJoinChat struct {
	optional           bool
	mock               *ChatServiceMock
	defaultExpectation *ChatServiceMockJoinChatExpectation
	expectations       []*ChatServiceMockJoinChatExpectation

	callArgs []*ChatServiceMockJoinChatParams
	mutex    sync.RWMutex
...
// ChatServiceMockJoinChatExpectation specifies expectation struct of the ChatService.JoinChat
type ChatServiceMockJoinChatExpectation struct {
	mock               *ChatServiceMock
	params             *ChatServiceMockJoinChatParams
	paramPtrs          *ChatServiceMockJoinChatParamPtrs
	expectationOrigins ChatServiceMockJoinChatExpectationOrigins
	results            *ChatServiceMockJoinChatResults
	returnOrigin       string
	Counter            uint64
}

// ChatServiceMockJoinChatParams contains parameters of the ChatService.JoinChat
type ChatServiceMockJoinChatParams struct {
	ctx context.Context
	cp1 *model.ChatMember
}

// ChatServiceMockJoinChatParamPtrs contains pointers to parameters of the ChatService.JoinChat
type ChatServiceMockJoinChatParamPtrs struct {
	ctx *context.Context
	cp1 **model.ChatMember
}

// ChatServiceMockJoinChatResults contains results of the ChatService.JoinChat
type ChatServiceMockJoinChatResults struct {
	jp1 *model.JoinChat
	err error
}

// ChatServiceMockJoinChatOrigins contains origins of expectations of the ChatService.JoinChat
type ChatServiceMockJoinChatExpectationOrigins struct {
	origin    string
	originCtx string
	originCp1 string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmJoinChat *mChatServiceMockJoinChat) Optional() *mChatServiceMockJoinChat {
	mmJoinChat.optional = true
	return mmJoinChat
}

// Expect sets up expected params for ChatService.JoinChat
func (mmJoinChat *mChatServiceMockJoinChat) Expect(ctx context.Context, cp1 *model.ChatMember) *mChatServiceMockJoinChat {
	if mmJoinChat.mock.funcJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Set")
	}

	if mmJoinChat.defaultExpectation == nil {
		mmJoinChat.defaultExpectation = &ChatServiceMockJoinChatExpectation{}
	}

	if mmJoinChat.defaultExpectation.paramPtrs != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by ExpectParams functions")
	}

	mmJoinChat.defaultExpectation.params = &ChatServiceMockJoinChatParams{ctx, cp1}
	mmJoinChat.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmJoinChat.expectations {
		if minimock.Equal(e.params, mmJoinChat.defaultExpectation.params) {
			mmJoinChat.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmJoinChat.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for ChatService.JoinChat
func (mmJoinChat *mChatServiceMockJoinChat) ExpectCtxParam1(ctx context.Context) *mChatServiceMockJoinChat {
	if mmJoinChat.mock.funcJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Set")
	}
	...
	if mmJoinChat.defaultExpectation.params != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Expect")
	}

	if mmJoinChat.defaultExpectation.paramPtrs == nil {
		mmJoinChat.defaultExpectation.paramPtrs = &ChatServiceMockJoinChatParamPtrs{}
	}
	mmJoinChat.defaultExpectation.paramPtrs.ctx = &ctx
	mmJoinChat.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmJoinChat
}

// ExpectCp1Param2 sets up expected param cp1 for ChatService.JoinChat
func (mmJoinChat *mChatServiceMockJoinChat) ExpectCp1Param2(cp1 *model.ChatMember) *mChatServiceMockJoinChat {
	if mmJoinChat.mock.funcJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Set")
	}
	...
	mmJoinChat.defaultExpectation.paramPtrs.cp1 = &cp1
	mmJoinChat.defaultExpectation.expectationOrigins.originCp1 = minimock.CallerInfo(1)

	return mmJoinChat
}

// Inspect accepts an inspector function that has same arguments as the ChatService.JoinChat
func (mmJoinChat *mChatServiceMockJoinChat) Inspect(f func(ctx context.Context, cp1 *model.ChatMember)) *mChatServiceMockJoinChat {
	if mmJoinChat.mock.inspectFuncJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("Inspect function is already set for ChatServiceMock.JoinChat")
	}

	mmJoinChat.mock.inspectFuncJoinChat = f

	return mmJoinChat
}

// Return sets up results that will be returned by ChatService.JoinChat
func (mmJoinChat *mChatServiceMockJoinChat) Return(jp1 *model.JoinChat, err error) *ChatServiceMock {
	if mmJoinChat.mock.funcJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Set")
	}

	if mmJoinChat.defaultExpectation == nil {
		mmJoinChat.defaultExpectation = &ChatServiceMockJoinChatExpectation{mock: mmJoinChat.mock}
	}
	mmJoinChat.defaultExpectation.results = &ChatServiceMockJoinChatResults{jp1, err}
	mmJoinChat.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmJoinChat.mock
}

// Set uses given function f to mock the ChatService.JoinChat method
func (mmJoinChat *mChatServiceMockJoinChat) Set(f func(ctx context.Context, cp1 *model.ChatMember) (jp1 *model.JoinChat, err error)) *ChatServiceMock {
	if mmJoinChat.defaultExpectation != nil {
		mmJoinChat.mock.t.Fatalf("Default expectation is already set for the ChatService.JoinChat method")
	}

	if len(mmJoinChat.expectations) > 0 {
		mmJoinChat.mock.t.Fatalf("Some expectations are already set for the ChatService.JoinChat method")
	}

	mmJoinChat.mock.funcJoinChat = f
	mmJoinChat.mock.funcJoinChatOrigin = minimock.CallerInfo(1)
	return mmJoinChat.mock
}

// When sets expectation for the ChatService.JoinChat which will trigger the result defined by the following
// Then helper
func (mmJoinChat *mChatServiceMockJoinChat) When(ctx context.Context, cp1 *model.ChatMember) *ChatServiceMockJoinChatExpectation {
	if mmJoinChat.mock.funcJoinChat != nil {
		mmJoinChat.mock.t.Fatalf("ChatServiceMock.JoinChat mock is already set by Set")
	}

	expectation := &ChatServiceMockJoinChatExpectation{
		mock:               mmJoinChat.mock,
		params:             &ChatServiceMockJoinChatParams{ctx, cp1},
		expectationOrigins: ChatServiceMockJoinChatExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmJoinChat.expectations = append(mmJoinChat.expectations, expectation)
	return expectation
}

// Then sets up ChatService.JoinChat return parameters for the expectation previously defined by the When method
func (e *ChatServiceMockJoinChatExpectation) Then(jp1 *model.JoinChat, err error) *ChatServiceMock {
	e.results = &ChatServiceMockJoinChatResults{jp1, err}
	return e.mock
}

// Times sets number of times ChatService.JoinChat should be invoked
func (mmJoinChat *mChatServiceMockJoinChat) Times(n uint64) *mChatServiceMockJoinChat {
	if n == 0 {
		mmJoinChat.mock.t.Fatalf("Times of ChatServiceMock.JoinChat mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmJoinChat.expectedInvocations, n)
	mmJoinChat.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmJoinChat
}

func (mmJoinChat *mChatServiceMockJoinChat) invocationsDone() bool {
	if len(mmJoinChat.expectations) == 0 && mmJoinChat.defaultExpectation == nil && mmJoinChat.mock.funcJoinChat == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmJoinChat.mock.afterJoinChatCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmJoinChat.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// JoinChat implements mm_service.ChatService
func (mmJoinChat *ChatServiceMock) JoinChat(ctx context.Context, cp1 *model.ChatMember) (jp1 *model.JoinChat, err error) {
	mm_atomic.AddUint64(&mmJoinChat.beforeJoinChatCounter, 1)
	defer mm_atomic.AddUint64(&mmJoinChat.afterJoinChatCounter, 1)

	mmJoinChat.t.Helper()

	if mmJoinChat.inspectFuncJoinChat != nil {
		mmJoinChat.inspectFuncJoinChat(ctx, cp1)
	}

	mm_params := ChatServiceMockJoinChatParams{ctx, cp1}

	// Record call args
	mmJoinChat.JoinChatMock.mutex.Lock()
	mmJoinChat.JoinChatMock.callArgs = append(mmJoinChat.JoinChatMock.callArgs, &mm_params)
	mmJoinChat.JoinChatMock.mutex.Unlock()

	for _, e := range mmJoinChat.JoinChatMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
	...
	if mmJoinChat.JoinChatMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmJoinChat.JoinChatMock.defaultExpectation.Counter, 1)
		mm_want := mmJoinChat.JoinChatMock.defaultExpectation.params
		mm_want_ptrs := mmJoinChat.JoinChatMock.defaultExpectation.paramPtrs

		mm_got := ChatServiceMockJoinChatParams{ctx, cp1}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmJoinChat.t.Errorf("ChatServiceMock.JoinChat got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmJoinChat.JoinChatMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.cp1 != nil && !minimock.Equal(*mm_want_ptrs.cp1, mm_got.cp1) {
				mmJoinChat.t.Errorf("ChatServiceMock.JoinChat got unexpected parameter cp1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmJoinChat.JoinChatMock.defaultExpectation.expectationOrigins.originCp1, *mm_want_ptrs.cp1, mm_got.cp1, minimock.Diff(*mm_want_ptrs.cp1, mm_got.cp1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmJoinChat.t.Errorf("ChatServiceMock.JoinChat got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmJoinChat.JoinChatMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmJoinChat.JoinChatMock.defaultExpectation.results
		if mm_results == nil {
			mmJoinChat.t.Fatal("No results are set for the ChatServiceMock.JoinChat")
		}
		return (*mm_results).jp1, (*mm_results).err
	}
	if mmJoinChat.funcJoinChat != nil {
		return mmJoinChat.funcJoinChat(ctx, cp1)
	}
	mmJoinChat.t.Fatalf("Unexpected call to ChatServiceMock.JoinChat. %v %v", ctx, cp1)
	return
}

// JoinChatAfterCounter returns a count of finished ChatServiceMock.JoinChat invocations
func (mmJoinChat *ChatServiceMock) JoinChatAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmJoinChat.afterJoinChatCounter)
}

// JoinChatBeforeCounter returns a count of ChatServiceMock.JoinChat invocations
func (mmJoinChat *ChatServiceMock) JoinChatBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmJoinChat.beforeJoinChatCounter)
}

// Calls returns a list of arguments used in each call to ChatServiceMock.JoinChat.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmJoinChat *mChatServiceMockJoinChat) Calls() []*ChatServiceMockJoinChatParams {
	mmJoinChat.mutex.RLock()

	argCopy := make([]*ChatServiceMockJoinChatParams, len(mmJoinChat.callArgs))
	copy(argCopy, mmJoinChat.callArgs)

	mmJoinChat.mutex.RUnlock()

	return argCopy
}

// MinimockJoinChatDone returns true if the count of the JoinChat invocations corresponds
// the number of defined expectations
func (m *ChatServiceMock) MinimockJoinChatDone() bool {
	if m.JoinChatMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.JoinChatMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.JoinChatMock.invocationsDone()
}

// MinimockJoinChatInspect logs each unmet expectation
func (m *ChatServiceMock) MinimockJoinChatInspect() {
	for _, e := range m.JoinChatMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ChatServiceMock.JoinChat at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterJoinChatCounter := mm_atomic.LoadUint64(&m.afterJoinChatCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.JoinChatMock.defaultExpectation != nil && afterJoinChatCounter < 1 {
		if m.JoinChatMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ChatServiceMock.JoinChat at\n%s", m.JoinChatMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ChatServiceMock.JoinChat at\n%s with params: %#v", m.JoinChatMock.defaultExpectation.expectationOrigins.origin, *m.JoinChatMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcJoinChat != nil && afterJoinChatCounter < 1 {
		m.t.Errorf("Expected call to ChatServiceMock.JoinChat at\n%s", m.funcJoinChatOrigin)
	}

	if !m.JoinChatMock.invocationsDone() && afterJoinChatCounter > 0 {
		m.t.Errorf("Expected %d calls to ChatServiceMock.JoinChat at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.JoinChatMock.expectedInvocations), m.JoinChatMock.expectedInvocationsOrigin, afterJoinChatCounter)
	}
}
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, mp1 *model.Message) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) ExpectMp1Param2(mp1 *model.Message) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, mp1 *model.Message)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, mp1 *model.Message) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, mp1 *model.Message) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, mp1 *model.Message) (err error) {
