...
//go:generate minimock -i github.com/erikqwerty/chat-server/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/erikqwerty/chat-server/pkg/db"
